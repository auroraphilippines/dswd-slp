          ...
          >
            ...
            >
              <div className="container mx-auto px-4 text-center relative z-10">
                ...
                >
                  A comprehensive digital platform designed to streamline
                  livelihood proposal management, participant tracking, and
              ...
              <div className="container mx-auto px-4">
                ...
                <div id="about-program" className="mb-20 scroll-mt-20">
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                      <div>
                        <p className="text-gray-700 mb-4">
                          ...
                          socio-economic status of program participants. A key
                          feature of our system is the comprehensive participant
                          backtracking functionality, which allows us to monitor
                          the progress of beneficiaries throughout their journey
                          in the program.
                        </p>
                        <p className="text-gray-700 mb-4">
                    ...
                    <div className="mt-8 grid md:grid-cols-3 gap-6">
                      <div className="bg-blue-50 p-6 rounded-lg">
                        ...
                        <p className="text-gray-700">
                          ...
                          initiatives, ensuring that interventions are
                          responsive to their needs and aspirations for
                      ...
                      <div className="bg-blue-50 p-6 rounded-lg">
                        ...
                        <p className="text-gray-700">
                          ...
                          with emphasis on sustainable income generation.
                        </p>
                      </div>
                      ...
                      <div className="bg-blue-50 p-6 rounded-lg">
                        ...
                        <p className="text-gray-700">
                          ...
                          through efficient processes, innovative approaches,
                    ...
                    <div className="mt-8 bg-blue-100 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700 mb-4">
                        Our advanced participant backtracking system allows
                      ...
                      <ul className="space-y-3 text-gray-700">
                        <li className="flex items-start">
                          ...
                          <span>
                            Track the complete journey of participants from
                        ...
                        <li className="flex items-start">
                          <ArrowRight className="h-5 w-5 text-[#0F4C81] mr-2 flex-shrink-0 mt-0.5" />
                          <span>
                            Monitor participation in training programs and
                            workshops
                          </span>
                        </li>
                        <li className="flex items-start">
                        ...
                        <li className="flex items-start">
                          <ArrowRight className="h-5 w-5 text-[#0F4C81] mr-2 flex-shrink-0 mt-0.5" />
                          <span>
                            Generate comprehensive reports on participant
                        ...
                        <li className="flex items-start">
                          <ArrowRight className="h-5 w-5 text-[#0F4C81] mr-2 flex-shrink-0 mt-0.5" />
                          <span>
                            Identify areas where additional support may be
                            needed
                          </span>
                        </li>
                      </ul>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="bg-blue-50 p-6 rounded-lg">
                        ...
                        <p className="text-gray-700 text-center">
                          ...
                          vulnerable, and disadvantaged, by providing
                          integrated, sustainable, and technology-driven
                          livelihood solutions that empower individuals and
                          communities to achieve self-sufficiency and improved
                          quality of life.
                        </p>
                      </div>
                      ...
                      <div className="bg-blue-50 p-6 rounded-lg">
                        ...
                        <p className="text-gray-700 text-center">
                          By 2030, the DSWD Sustainable Livelihood Program
                          envisions a Philippines where every Filipino family
                          enjoys a decent, dignified, and sustainable
                          livelihood, supported by efficient, transparent, and
                          accessible digital systems that facilitate equitable
                    ...
                    <div className="mt-8 bg-blue-100 p-6 rounded-lg">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white p-4 rounded-lg text-center">
                          ...
                          <p className="text-sm text-gray-600">
                            We serve with genuine care and empathy for the
                        ...
                        <div className="bg-white p-4 rounded-lg text-center">
                          ...
                          <p className="text-sm text-gray-600">
                            We ensure openness and accountability in all our
                ...
                <div id="history" className="mb-20 scroll-mt-20">
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
                    <div className="mb-8">
                      <p className="text-gray-700">
                        The Sustainable Livelihood Program has evolved over the
                        years to better serve the needs of vulnerable Filipinos.
                    ...
                    <div className="space-y-8">
                      <div className="flex">
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg flex-1">
                          ...
                          <p className="text-gray-700">
                            The Sustainable Livelihood Program was established
                            as a community-based capacity building program that
                            seeks to improve the socio-economic status of
                            program participants. It replaced the previous
                      ...
                      <div className="flex">
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg flex-1">
                          ...
                          <p className="text-gray-700">
                            ...
                            Development Track and Employment Facilitation Track
                      ...
                      <div className="flex">
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg flex-1">
                          ...
                          <p className="text-gray-700">
                            The DSWD began the digital transformation of the
                            SLP, developing initial systems to track
                            beneficiaries and program implementation. This laid
                            the groundwork for more comprehensive digital
                            solutions.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex">
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg flex-1">
                          ...
                          <p className="text-gray-700">
                            The program adapted to address the challenges posed
                            by the COVID-19 pandemic, providing emergency
                            livelihood assistance to affected families and
                            communities, and accelerating digital transformation
                            efforts.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex">
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg flex-1">
                          ...
                          <p className="text-gray-700">
                            The Sustainable Livelihood Program - Proposal System
                            was launched as a comprehensive digital platform to
                            streamline program implementation, enhance
                            monitoring and evaluation, and improve service
                            delivery to beneficiaries nationwide.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          <p className="text-sm text-yellow-700">
                            <strong>Note:</strong> The SLP continues to evolve
                            based on lessons learned, stakeholder feedback, and
                            emerging needs of communities. Our commitment to
                ...
                <div id="team" className="scroll-mt-20 mb-20">
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
                    <p className="text-gray-700 mb-8">
                      The Sustainable Livelihood Program is led by a dedicated
                      team of professionals committed to improving the lives of
                      vulnerable Filipinos through sustainable livelihood
                      opportunities.
                    </p>
                    ...
                    <div className="mb-10">
                      ...
                      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">
                            Dr. Santos leads the Sustainable Livelihood Program
                            and its affiliated colleges with over 15 years of
                            experience in social welfare and community
                            development. She oversees all strategic initiatives
                            and ensures the program's alignment with DSWD's
                            mission to empower vulnerable communities across the
                            Philippines.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-blue-50 p-6 rounded-lg flex flex-col md:flex-row items-center md:items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700">
                              Architected and developed the core functionality
                              of the SLP Proposal System, with expertise in
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg flex flex-col md:flex-row items-center md:items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700">
                              ...
                              SLP-PS, ensuring the system is intuitive,
